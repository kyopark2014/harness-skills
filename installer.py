...
def create_cloudfront_distribution(s3_bucket_name: str) -> Dict[str, str]:
    ...
    logger.info("[11/11] Creating CloudFront distribution")
...
def create_harness_execution_role() -> str:
    ...
    logger.info("[5/11] Creating Harness execution IAM role")
...
def create_agentcore_memory_role() -> str:
    ...
    logger.info("[6/11] Creating AgentCore Memory IAM role")
...
def create_agentcore_memory(role_arn: str, user_id: str = "installer") -> str:
    ...
    """
    logger.info("[7/11] Creating AgentCore Memory")
...
def create_or_get_harness(
    ...
    logger.info("[10/11] Creating AgentCore Harness")
...
def main():
    ...
    try:
        ...
        logger.info("[8/11] Ensuring VPC for Harness (S3 Files requires VPC mode)")
        vpc_info = provisioner.ensure_vpc()
        logger.info("[9/11] Creating S3 Files session storage")
